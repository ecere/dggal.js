...
To install the latest NPM package ( https://www.npmjs.com/package/dggal ):

`npm install dggal`

To build for WebAssembly from source using the NPM packaging and run the _DGGAL in the browser_ demo:

```
git clone https://github.com/ecere/dggal.js
cd dggal.js
npm run start
```

Permalink to the latest DGGAL.js library:

https://dggal.org/web/latest/dggal.js
